...
pub const Language = union(enum) {
    ...
    pub fn init(allocator: u.Allocator, filename: []const u8, source: []const u8) Language {
        return if (std.mem.endsWith(u8, filename, ".zig"))
            ...
            .{ .Typescript = generic.State.init(allocator, "//", source) }
    ...
    pub fn updateBeforeChange(self: *Language, source: []const u8, delete_range: [2]usize) void {
        switch (self.*) {
            ...
            .Java, .Shell, .Julia, .Javascript, .Typescript, .Nix, .C => |*state| state.updateBeforeChange(source, delete_range),
            .Unknown => {},
        }
    }
    ...
    pub fn updateAfterChange(self: *Language, source: []const u8, insert_range: [2]usize) void {
        switch (self.*) {
            ...
            .Java, .Shell, .Julia, .Javascript, .Typescript, .Nix, .C => |*state| state.updateAfterChange(source, insert_range),
            .Unknown => {},
        }
    }
    ...
    pub fn toggleMode(self: *Language) void {
        switch (self.*) {
            ...
            .Java, .Shell, .Julia, .Javascript, .Typescript, .Nix, .C => |*state| state.toggleMode(),
            .Unknown => {},
        }
    }
    ...
    pub fn getCommentString(self: Language) ?[]const u8 {
        return switch (self) {
            .Zig => "//",
            .Clojure => ";",
            .Java, .Shell, .Julia, .Javascript, .Typescript, .Nix, .C => |*state| state.comment_string,
            .Unknown => null,
        };
    }
    ...
    pub fn highlight(self: Language, allocator: u.Allocator, source: []const u8, range: [2]usize) []const u.Color {
        ...
        switch (self) {
            ...
            .Java, .Shell, .Julia, .Javascript, .Typescript, .Nix, .C => |state| state.highlight(source, range, colors),
            .Unknown => {},
        }
        return colors;
    }
    ...
    pub fn getTokenRanges(self: Language) []const [2]usize {
        return switch (self) {
            ...
            .Java, .Shell, .Julia, .Javascript, .Typescript, .Nix, .C => |state| state.token_ranges,
            .Unknown => &[0][2]usize{},
        };
    }
    ...
    pub fn getParenLevels(self: Language) []const usize {
        return switch (self) {
            ...
            .Java, .Shell, .Julia, .Javascript, .Typescript, .Nix, .C => |state| state.paren_levels,
            .Unknown => &[0]?usize{},
        };
    }
    ...
    pub fn getParenParents(self: Language) []const ?usize {
        return switch (self) {
            ...
            .Java, .Shell, .Julia, .Javascript, .Typescript, .Nix, .C => |state| state.paren_parents,
            .Unknown => &[0]?usize{},
        };
    }
    ...
    pub fn getParenMatches(self: Language) []const ?usize {
        return switch (self) {
            ...
            .Java, .Shell, .Julia, .Javascript, .Typescript, .Nix, .C => |state| state.paren_matches,
            .Unknown => &[0]?usize{},
        };
    }
    ...
    pub fn format(self: Language, source: []const u8) ?[]const u8 {
        return switch (self) {
            ...
            .Java, .Shell, .Julia, .Javascript, .Typescript, .Nix, .C => |state| stripTrailingWhitespace(state.allocator, source),
            .Unknown => null,
        };
    }
    ...
    pub fn getAddedIndent(self: Language, token_ix: usize) usize {
        return switch (self) {
            ...
            .Java, .Shell, .Julia, .Javascript, .Typescript, .Nix, .C => |state| state.getAddedIndent(token_ix),
            .Unknown => 0,
        };
    }

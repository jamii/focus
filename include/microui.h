...
typedef struct { int x, y; unsigned char dummy[16]; } mu_Vec2;
typedef struct { int x, y, w, h; unsigned char dummy[16]; } mu_Rect;
typedef struct { unsigned char r, g, b, a; unsigned char dummy[16];} mu_Color;
